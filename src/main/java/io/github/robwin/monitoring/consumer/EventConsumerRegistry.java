...
public interface EventConsumerRegistry {
    ...
    CircularEventConsumer<CircuitBreakerEvent> getCircularEventConsumer(String circuitBreakerName);

    Seq<CircularEventConsumer<CircuitBreakerEvent>> getAllCircularEventConsumer();
}
