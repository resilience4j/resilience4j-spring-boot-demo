...
The emitted CircuitBreaker are stored in a circular event consumer buffer per CircuitBreaker instance. The size of the event consumer buffers are configurable.
